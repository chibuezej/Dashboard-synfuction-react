...
const Ecommerce = () => {
  return (
   ...
   <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center max-md:mb-40">
<div className="flex justify-between items-center">
      <div className='max-md:mb-1 '>
          <img src={svg} alt="svg" className=' w-full'/>
        <p className="font-bold text-gray-400">Earnings</p>
        <p className="text-2xl">$100,000,000.23</p>
      </div>
    </div>
    <Button 
    color="white"
    ...
    {earningData.map((item) => (
      ...
      className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2x1">
        ...
        <p className='mt-3'>
          ...
          <span className={`text-sm text-green-${item.pcColor} ml-2`}>
            {item.percentage}
          </span>
          </p>
